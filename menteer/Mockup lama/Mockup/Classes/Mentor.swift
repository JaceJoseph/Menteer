...
class Mentor:User{
    ...
    init(name: String, image: UIImage, phone: String, email: String, reviews: [textWithIcon], jobExperience: [textWithIcon], education: [textWithIcon], others: [textWithIcon], goal: [String], desc: String,material:String) {
