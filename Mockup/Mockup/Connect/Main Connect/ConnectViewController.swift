...
class ConnectViewController: UIViewController {
    ...
    func populateMentorArray()->[Mentor]{
        ...
        tempConnectArray.append(Mentor(name: "Jack Kun", image: #imageLiteral(resourceName: "Castro"), phone: "993465", email: "jackkunma@email.com",
        ...
        tempConnectArray.append(Mentor(name: "Elizabeth Conway", image: #imageLiteral(resourceName: "Brittany mentor"), phone: "993465", email: "jackkunma@email.com",
